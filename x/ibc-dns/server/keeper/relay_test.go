...
func (suite *DNSKeeperTestSuite) openALLChannels() {
	suite.openChannels(
		suite.app1.chainID,
	...
	suite.openChannels(
		suite.dns0.chainID,
		suite.app0.chainID+suite.dns0.chainID,
		suite.chA0toD0,
		suite.app0,

		suite.app0.chainID,
		suite.dns0.chainID+suite.app0.chainID,
		suite.chD0toA0,
		suite.dns0,
	)
	...
	suite.openChannels(
		suite.dns0.chainID,
		suite.app1.chainID+suite.dns0.chainID,
		suite.chA1toD0,
		suite.app1,

		suite.app1.chainID,
		suite.dns0.chainID+suite.app1.chainID,
		suite.chD0toA1,
		suite.dns0,
	)
}

func createPacket(data []byte, src, dst ChannelInfo, seq uint64) channel.Packet {
	return channel.NewPacket(data, seq, src.Port, src.Channel, dst.Port, dst.Channel, 100000, 0)
}
